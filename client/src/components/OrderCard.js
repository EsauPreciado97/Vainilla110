    ...
    >
      <div style={{ marginLeft: 20 }}>
        ...
        <Typography gutterBottom variant="body1" color="textPrimary">
          {role === "ROLE_USER" && `Ordenar de - ${order.seller.name}`}
          {role === "ROLE_SELLER" &&
            `Ordenar para - ${order.user.name}, +52 ${order.user.address.phoneNo}`}
        </Typography>
        {role === "ROLE_USER" && (
          <Typography gutterBottom variant="body1" color="textPrimary">
            Teléfono - +52 {order.seller.phone}
          </Typography>
        )}
        ...
        <Typography gutterBottom variant="body1" color="textPrimary">
          Ordenado a - {dayjs(order.createdAt).fromNow()}
        </Typography>
