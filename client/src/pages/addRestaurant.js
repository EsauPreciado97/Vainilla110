      ...
      <Grid container>
              ...
              <Grid item sm>
                ...
                <form noValidate onSubmit={handleSubmit}>
                  <TextField
                    ...
                    placeholder="El nombre comercial"
                  ...
                  <TextField
                    ...
                    placeholder="Mexicana, italiana, sushi..."
                    className={classes.textField}
                    onChange={handleInputChange}
                    value={inputs.tags}
                  ...
                  <TextField
                    ...
                    placeholder="Costo promedio por persona"
                    className={classes.textField}
                    onChange={handleInputChange}
                  ...
                  <TextField
                    id="minOrderAmount"
                    name="minOrderAmount"
                    label="Tarifa mínima para ordenar"
                    placeholder="Monto mínimo para garantizar el servicio"
                    className={classes.textField}
                    onChange={handleInputChange}
                  ...
                  {serverError && (
                    <Typography variant="body2" className={classes.customError}>
                      {"Por el momento no podemos procesar tu solicitud, intenta más tarde"}
                    </Typography>
                  )}
                  ...
                  >
                    Forma parte de la red de restaurantes de Vainilla 110
                  </small>
                </form>
              </Grid>
            </Grid>
        ...
        <Grid item xs={3} style={{ marginLeft: "40px" }}>
          ...
          >
            ...
            >
              1. Registra tu restaurante en la plataforma. <br />
              2. Verifica tu cuenta de correo electrónico. <br />
              3. Carga tus platillos y ¡comienza a vender!
              <br />
              <br />
              <br />
            </Typography>
